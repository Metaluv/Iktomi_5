  ...
  return (
    <div>
      ...
      <footer>
        ...
        <div className={styles.foottext}> Thank you for testing out my app. If you like what you see and want to help with the costs you for Iktomi - Storyteller click the donate button! If you have suggestion of improvement please email at j@cardinaltrading.co</div>
